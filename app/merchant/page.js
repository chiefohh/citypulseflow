        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '120px 24px 80px' }}>
          ...
          <div style={{ marginTop: 48 }}>
            ...
            <p style={{
              ...
              Define the boundaries. PulseEngine generates offers autonomously within them.
            </p>
            ...
            <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap' }}>
              <RuleCard
                ...
                params={[
                  ...
                  { label: 'Headline',       value: 'PulseEngine',  source: 'ai',       accent: '#22C55E' },
                  { label: 'Offer Copy',     value: 'PulseEngine',  source: 'ai',       accent: '#22C55E' },
                ]}
              />
              <RuleCard
                ...
                params={[
                  ...
                  { label: 'Expiry Window',     value: 'PulseEngine',   source: 'ai',       accent: '#22C55E' },
                ]}
              />
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                {' '}Offers are generated autonomously by PulseEngine — every headline, product choice,
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 16, margin: '16px 0 14px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <span style={{ fontFamily: '"Inter", sans-serif', fontSize: 11, color: '#475569', letterSpacing: '0.05em' }}>Generated by PulseEngine</span>
        </div>
      </div>
